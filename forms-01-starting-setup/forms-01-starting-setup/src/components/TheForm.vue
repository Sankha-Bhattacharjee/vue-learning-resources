<template>
  <form @submit.prevent="submitForm">
    <div class="form-control" :class="{invalid:userNameValidity==='invalid'}">
      ...
      <p v-show="userNameValidity === 'invalid'">Please enter valid name!</p>
    </div>
    ...
    <div id="form-control">
      <input type="checkbox" id="confirm-item" name="confirm-item" v-model="confirm"/>
      <label for="confirm-item"> Are you sure?</label>
    </div>
    <div>
...
export default {
  ...
  methods:{
    submitForm(){
      ...
      console.log(this.userAge + 5); // v-model converts it to type number
      console.log(this.$refs.ageInput.value + 5); //refs acts as a default javascript so it takes value as a string
      this.userAge=null;
